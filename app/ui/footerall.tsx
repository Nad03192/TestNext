export default function FooterAll() {
  return (
    <footer className="bg-white shadow-md dark:bg-gray-900 py-8">
      <div className="container mx-auto px-6 md:px-12 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
         
          <div className="flex flex-col items-center md:items-start">
            <h2 className="text-2xl font-bold">NexaNova</h2>
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <div className="flex space-x-4 mt-3">
              ...
              <a href="#" aria-label="LinkedIn" className="text-gray-400 hover:text-blue-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
